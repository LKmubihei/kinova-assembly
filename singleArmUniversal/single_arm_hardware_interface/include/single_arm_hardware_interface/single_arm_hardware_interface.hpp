#ifndef SINGLE_ARM_HARDWARE_INTERFACE__SINGLE_ARM_HARDWARE_INTERFACE_HPP_
#define SINGLE_ARM_HARDWARE_INTERFACE__SINGLE_ARM_HARDWARE_INTERFACE_HPP_
...
namespace single_arm_hardware_interface
{
  ...
  class SingleArmHardwareInterface : public hardware_interface::SystemInterface
  {
    public:
      ...
      RCLCPP_SHARED_PTR_DEFINITIONS(SingleArmHardwareInterface)

      SINGLE_ARM_HARDWARE_INTERFACE_PUBLIC
      ...
      virtual ~SingleArmHardwareInterface();
...
#endif  // SINGLE_ARM_HARDWARE_INTERFACE__SINGLE_ARM_HARDWARE_INTERFACE_HPP_
