 ...
 * @param pose_acc 笛卡尔位姿加速度，单位：mm/s^2，rad/s^2
 * @param dof 机器人自由度
 * @param tool 工具描述
 * @param wobj 工具描述
 */
extern void init_R_KINE_VEL3(R_KINE_VEL* rkine_vel, double* joint, double* joint_vel, double* joint_acc,double* pose_vel,double* pose_acc, int dof, TOOL* tool, WOBJ* wobj);
 ...
 *
 * @param rkine_acc 运动加速度
 * @param joint_zcc 关节运动加速度，单位：rad/s^2
 * @return 关节运动加速度
 */
 ...
 * @param pose_vel 笛卡尔位姿加速度，单位：mm/s^2，rad/s^2
 * @return 笛卡尔位姿加速度
 */
 ...
 */
extern void Kine_Jacob(const char* serialLinkName, double *position, double** jac);
 ...
 */
extern int Kine_JacobInv(const char* serialLinkName, double *position, double** jacpinv);
 ...
 */
extern void Kine_JacobDot(const char* serialLinkName, double *position, double *velocity,double* jacdot);
