...
def main(args=None):
    ...
    init_pose = Move_cmd(0.223, 0.096, 0.29, 0.04, -3.14, 0.01, 0.1, 0.2)
    
    
    sub_1_pose = Move_cmd(0.223,0.096, 0.214, 0.04, -3.14, 0.01, 0.1, 0.2)
    sub_2_pose = Move_cmd(0.223, 0.096, 0.178, 0.04, -3.14, 0.01, 0.1, 0.2)
    goal_pose = Move_cmd(0.223, 0.096, 0.14, 0.04, -3.14, 0.01, 0.1, 0.2)
    ...
    robot_move_node.send_goal(init_pose)
    time.sleep(0.5)
    # gripper_cmd_node.send_gripper_command(gripper_open)
    robot_move_node.send_goal(sub_1_pose)
    #time.sleep(0.5)
    #gripper_cmd_node.send_gripper_command(gripper_grab)
    # time.sleep(1)
    robot_move_node.send_goal(sub_2_pose)
    time.sleep(0.5)
    robot_move_node.send_goal(goal_pose)
