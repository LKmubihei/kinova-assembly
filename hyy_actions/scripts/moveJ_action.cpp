...
#include "hyy_message/action/move_j.hpp"
#include "hyy_message/msg/joint_pose.hpp"
...
{
public:
    using MoveJ = hyy_message::action::MoveJ;
...
private:
    ...
    {
        auto JointGoal = hyy_message::msg::JointPose();
        JointGoal =  goal->goal;
