...
#include "hyy_message/action/move_js.hpp"
#include "hyy_message/msg/joint_pose_s.hpp"
...
{
public:
    using MoveJs = hyy_message::action::MoveJs;
...
private:
    ...
    {
        auto JointGoal = hyy_message::msg::JointPoseS();
        JointGoal =  goal->goal;
